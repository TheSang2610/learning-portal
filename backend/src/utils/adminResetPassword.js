...
//
//   MAT_KHAU_MOI='mat-khau-that-cua-ban' node src/utils/adminResetPassword.js
//
// Doi tai khoan khac thi them EMAIL:
//
//   EMAIL=ai.do@gmail.com MAT_KHAU_MOI='...' node src/utils/adminResetPassword.js
//
...
const { BCRYPT_ROUNDS, DAI_MAT_KHAU_TOI_THIEU } = require('./password');
