...
// nhau. Cung ly do voi utils/password.js.
//
// ---------------------------------------------------------------------------
// VI SAO BAM BANG BCRYPT CHU KHONG PHAI SHA-256
// ---------------------------------------------------------------------------
//
// utils/verificationToken.js noi ro la KHONG dung bcrypt cho token xac minh email,
...
// verificationToken.js - bam SHA-256, khong bcrypt.

const crypto = require('crypto');
const bcrypt = require('bcryptjs');
const { BCRYPT_ROUNDS } = require('./password');
const { bamToken } = require('./verificationToken');
...
// chu "khong noi con bao lau" trong controllers/passwordResetController.js.
