 ...
 * ban thieu mot buoc, va do chinh la cach lo hong cu o quyenNoiDung.js sinh ra.
 */
...
const { duocXemNoiDung } = require('./quyenNoiDung');
 ...
 * trong nhacTroLy.js va timNguoiDungTuToken trong authMiddleware.
 */
