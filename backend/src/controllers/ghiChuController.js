 ...
 *
 *   1. Cong bai hoc (utils/congBaiHoc.js) - phai co quyen xem noi dung khoa.
...
const GhiChuBaiHoc = require('../models/GhiChuBaiHoc');
const { layBaiTrongKhoa, traLoiCong } = require('../utils/congBaiHoc');
