                  ...
                  <tr key={lesson._id} className="hover:bg-slate-50/50 transition">
                    ...
                    <td className="p-5">
                      {matchingQuiz ? (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-slate-400">({matchingQuiz.questions?.length || 0} câu hỏi)</span>
                        </div>
                      ) : (
                        <span className="text-xs text-slate-400 italic">Chưa có bài tập</span>
                      )}
                    </td>
                    ...
                    <td className="p-5 text-right space-y-2 lg:space-y-0 lg:space-x-2 block lg:table-cell">
                      ...
                      {!matchingQuiz ? (
                        ...
                        <Link 
                          href={`/admin/courses/${courseId}/lessons/${lesson._id}/quiz/create`}
                        ...
                        <>
                          <Link 
                            href={`/admin/courses/${courseId}/lessons/${lesson._id}/quiz/edit`}
                      ...
                      <span className="text-slate-200 hidden lg:inline mx-1">|</span>
