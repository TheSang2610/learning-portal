...
export default function AdminLessonCreatePage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto py-4 px-4">
      {/* HEADER */}
      <div>
        <Link href={`/admin/courses/${courseId}/lessons`} className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-800 transition mb-2">
          <ArrowLeft size={16} /> Quay lại giáo trình
        </Link>
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Thêm Bài Học Mới</h1>
        <p className="text-xs text-slate-400 mt-1">Thiết kế cấu trúc video bài giảng và nội dung đính kèm.</p>
      </div>
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 flex items-center justify-between">
            <div>
              ...
              <span className="text-[11px] text-slate-400">Cho phép người dùng chưa mua khóa học được xem video này miễn phí.</span>
            </div>
