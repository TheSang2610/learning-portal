    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center text-slate-500">
          ...
          <p className="text-xs text-slate-500 mt-1">Bấm nút "Add Course FAQ" ở trên để bổ trợ nội dung giải đáp cho học viên.</p>
        </div>
      ) : (
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden border border-slate-100">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
              ...
              <button onClick={() => setIsOpenModal(false)} className="text-slate-500 hover:text-slate-600 p-1 rounded-lg">
                <X size={18} />
              </button>
            </div>
