    ...
    const loadSearchData = async () => {
      try {
        ...
        if (categoryParam.trim() !== "") {
          filtered = filtered.filter((course: any) => slugOf(course) === categoryParam.trim());
        }
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen pb-16">
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {courses.length === 0 ? (
          <div className="text-center py-16 text-gray-500 bg-white rounded-2xl border border-dashed border-gray-200 shadow-sm">
